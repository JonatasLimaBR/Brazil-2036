...
| 2026-09-05 | 1.4 | `/verify-spec` independente = OVERALL PASS; achado E1 (D6 do desvio de rota nacional) corrigido, W1 (D6 XLSX em RAW) aceito como desvio documentado. Shipped and archived. | /ship (Claude Sonnet 5) |
