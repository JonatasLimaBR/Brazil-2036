# ADR-023 — Observability from first agent commit
...
### C. Trace from first agent implementation
Alternativa escolhida ou base para a decisão.

## Decisão
**Trace from first agent implementation.**

## Por que
Agent debugging without traces is guesswork.
