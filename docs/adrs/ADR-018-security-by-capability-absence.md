# ADR-018 — Security by capability absence
...
### C. Forbidden tool not registered
...
## Por que
Impossible beats probabilistic compliance.
...
Some workflows need separate privileged agents/services.
