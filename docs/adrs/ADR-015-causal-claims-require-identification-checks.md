# ADR-015 — Causal claims require identification checks
...
### C. Return NOT_IDENTIFIED when assumptions fail
Alternativa escolhida ou base para a decisão.

## Decisão
**Return NOT_IDENTIFIED when assumptions fail.**

## Por que
Avoids false causal certainty.
...
Some analyses produce no causal answer.
