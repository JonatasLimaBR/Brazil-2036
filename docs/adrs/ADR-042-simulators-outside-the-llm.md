# ADR-042 — Simulators outside the LLM
...
### C. Dedicated simulation services
Alternativa escolhida ou base para a decisão.

## Decisão
**Dedicated simulation services.**

## Por que
Reproducibility and numeric correctness.
