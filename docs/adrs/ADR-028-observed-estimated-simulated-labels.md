# ADR-028 — Observed/Estimated/Simulated labels
...
### C. Typed classification in data/API/UI
Alternativa escolhida ou base para a decisão.

## Decisão
**Typed classification in data/API/UI.**

## Por que
Prevents scenario from looking official.
...
UI/API contracts become stricter.
