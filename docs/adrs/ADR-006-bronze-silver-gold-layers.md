# ADR-006 — Bronze/Silver/Gold layers
...
## Por que
Clear separation of source fidelity, standardization and products.
...
More transformations and governance objects.
