...
### B. Reviewer may patch but not commit
...
### C. Reviewer cannot modify implementation
...
## Por que
A reviewer that fixes becomes an author.
...
Findings require another author iteration.
