# ADR-014 — Champion/challenger forecasting
...
### C. Backtested champion/challenger
Alternativa escolhida ou base para a decisão.

## Decisão
**Backtested champion/challenger.**

## Por que
Model choice should follow measured performance.
...
Operational complexity of multiple models.
