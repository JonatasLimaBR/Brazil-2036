# ADR-025 — SSE for agent progress
...
### C. SSE for server-to-client streams
Alternativa escolhida ou base para a decisão.

## Decisão
**SSE for server-to-client streams.**

## Por que
Simple fit for streamed answers/events.
...
Bidirectional realtime use cases may need WebSocket later.
