# ADR-017 — Capability-based agent permissions
...
### C. Per-agent allowlisted tools
Alternativa escolhida ou base para a decisão.

## Decisão
**Per-agent allowlisted tools.**

## Por que
Security should survive prompt injection.
...
More specialized agent configurations.
