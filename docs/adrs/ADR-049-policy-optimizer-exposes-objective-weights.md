# ADR-049 — Policy optimizer exposes objective weights
...
### C. Explicit objective/constraints/weights
Alternativa escolhida ou base para a decisão.

## Decisão
**Explicit objective/constraints/weights.**

## Por que
Avoid normative opacity.
