# ADR-011 — IBGE municipality code as territorial key
...
### C. IBGE code canonical + surrogate optional
Alternativa escolhida ou base para a decisão.

## Decisão
**IBGE code canonical + surrogate optional.**

## Por que
Stable public identifier enables cross-source joins.
...
Need mapping for historic changes/exceptions.
