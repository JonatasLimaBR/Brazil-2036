# ADR-022 — Pre-trace PII redaction
...
### C. Redact before observability sink
Alternativa escolhida ou base para a decisão.

## Decisão
**Redact before observability sink.**

## Por que
Once logged, sensitive data is already exposed.
...
Some debugging detail is intentionally lost.
