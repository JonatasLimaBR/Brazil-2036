...
### C. /api/v1 with explicit evolution
Alternativa escolhida ou base para a decisão.

## Decisão
**/api/v1 with explicit evolution.**

## Por que
Third-party reuse requires stable contracts.
