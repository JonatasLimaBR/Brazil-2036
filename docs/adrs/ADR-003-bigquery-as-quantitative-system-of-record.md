# ADR-003 — BigQuery as quantitative system of record
...
## Por que
Analytical scale, SQL, BQML and GCP integration fit national indicators.
...
Do not use it as primary transactional store.
