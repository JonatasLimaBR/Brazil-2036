# ADR-037 — Vendored/pinned coding skills
...
### C. Vendored skill + pinned SHA
Alternativa escolhida ou base para a decisão.

## Decisão
**Vendored skill + pinned SHA.**

## Por que
Reproducibility and supply-chain control.
