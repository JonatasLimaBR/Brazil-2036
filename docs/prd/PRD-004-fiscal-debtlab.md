# PRD-004 — Fiscal & DebtLab

## 1. Problema
Análise fiscal exige integrar receita, despesa, resultado primário, juros e dívida.
...
- equação de dinâmica
- cenários de juros/crescimento/primário
- simulador DebtLab

## 5. Fora de escopo V1
- recomendação normativa automática
- publicação de meta oficial
...
- premissas persistidas
- P10/P50/P90 quando probabilístico
