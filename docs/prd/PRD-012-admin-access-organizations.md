# PRD-012 — Admin, Access & Organizations

## 1. Problema
A plataforma precisa separar organizações, funções e ações sensíveis.
...
- four-eyes enforced where required
