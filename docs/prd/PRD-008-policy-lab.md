...
## 1. Problema
Usuários precisam testar premissas e comparar impactos sem confundir cenário com fato.
...
## 4. Escopo V1
- cenários base/stress/nos-trilhos/custom
- sliders
- comparação
- persistência
...
## 5. Fora de escopo V1
- recomendação política automática como verdade
