# PRD-013 — Developers & APIs

## 1. Problema
Terceiros precisam reutilizar indicadores e produtos derivados.
...
## 4. Escopo V1
- OpenAPI
- API keys/OAuth conforme perfil
- quotas
- examples
- SDK TS inicial
- provenance endpoint
...
## 5. Fora de escopo V1
- acesso a raw restrito
- breaking API sem versionamento
