# PRD-003 — Macro Economic Twin

## 1. Problema
Usuários precisam conectar PIB, inflação, juros, câmbio, consumo, investimento e produtividade.
...
## 5. Fora de escopo V1
- modelo macroeconômico estrutural definitivo
- nowcasting de alta frequência completo
...
- forecast backtest publicado
- 100% das séries com fonte
- tempo de consulta dentro do SLO
