# PRD-018 — Agentic Developer Experience

## 1. Problema
O desafio exige uso explícito e disciplinado de agentes de código.
...
## 5. Fora de escopo V1
- direct PROD deploy by coding agent
- reviewer write access
- CI warnings that do not block
