# PRD-010 — Agent Center

## 1. Problema
Usuários precisam interagir com agentes especializados com segurança e rastreabilidade.
...
## 5. Fora de escopo V1
- agent com acesso irrestrito
- write em dado oficial por prompt
